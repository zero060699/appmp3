...
import com.example.appmp3.Activity.DanhsachbaihatActivity;
import com.example.appmp3.Activity.DanhsachtatcachudeActivity;
...
import com.example.appmp3.Model.Theloaitrongngay;
            ...
            public void onResponse(Call<Theloaitrongngay> call, Response<Theloaitrongngay> response) {
                ...
                for (int i=0; i< (chuDeArrayList.size()) ; i++){
                    ...
                    imageView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent=new Intent(getActivity(), DanhsachtheloaitheochudeMainActivity.class);
